    ...
    <div className="group block relative">
      ...
      <button
        ...
        className={`absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 shadow-sm ${
          wishlisted ? "bg-black text-white" : "bg-white text-neutral-400 hover:text-black opacity-0 group-hover:opacity-100"
        }`}
        aria-label={wishlisted ? "Remove from wishlist" : "Save to wishlist"}
      >
        <Heart className="h-3.5 w-3.5" strokeWidth={1.5} fill={wishlisted ? "currentColor" : "none"} />
      </button>
